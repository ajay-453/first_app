...
Behavioral guidelines for working in this repo. Based on [multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills) — guidelines distilled from Andrej Karpathy's observations on common LLM coding mistakes.
...
**3P Explorer** — an AI-powered "Top 3" ranker. Enter any topic, get the definitive top three with reasons and links.
